...
def Register_course(line):
    ...
    while(t==0):
        ...
        if(c==18):
            print("The last course that you added will not register bec.you exceed the 18 hour in one semester")
            t=1
...
def choose_group(student_id, group):
    ...
    if existing_group :
        print(f"Student {student_id} is already part of Group {existing_group}.")
    else:
...
###########################################################################
        ...
        conID=19645820
        password="controlalgam3aalgamed"
        while(True):
        ...
        while(True):
         ...
         if(num1=='1'):
            ...
            while(True):
                print("Please enter do you to change group or course or Gpa or level or pass: ")
...
5. If you want to change in pass please select 5.
                ...
                if(num2=='1'):
                    ...
                    t='c'
                    val=input("Enter the courses name that you want to edit it: ")
                    editStd(id,t,val)
                    break
                elif(num2=='3'):
                    t='g'
